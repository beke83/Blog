...
if (isset($_POST["Submit"])) {
    ...
    if (empty($Username) || empty($Password) || empty($ConfirmPassword)) {
        ...
        global $Connection;
        $Query = "INSERT INTO admins_tbl(datetime,username,password,addedby)
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Manage Admins Access</h1>
                    </div>
                    <?php echo Message();
                    echo SuccessMessage();
                    ?>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                global $Connection;
                                                $ViewQuery = "SELECT * FROM admins_tbl ORDER BY id desc";
