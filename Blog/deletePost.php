...
if (isset($_POST["Submit"])) {
    ...
    if (empty($Title)) {
       ...
       $Query = "DELETE FROM admin_panel WHERE id='$DeleteFromURL'";
        ...
        //move images to the specified folder upload
...
<head>
    ...
    <title>Happy Blog - Delete Post</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Delete Post</h1>
                    </div>
                    <?php echo Message();
                    echo SuccessMessage();
                    ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="deletePost.php?Delete=<?php echo $SearchQueryParameter; ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $TitletoUpdated; ?>" type="text" class="form-control" name="Title" id="title" placeholder="Title" />
                                        </div>
                                        <div class="form-group">
                                            <span>Existing Category: </span>
                                            <?php echo $CategorytoUpdated; ?>
                                            <br>
                                            ...
                                            <select class="form-control" id="categoryselect" name="Category">
                                                ...
                                                <?php
                                                global $Connection;
                                                $ViewQuery = "SELECT * FROM category_tbl ORDER BY datetime desc";
                                            ...
                                            <img src="upload/<?php echo $ImagetoUpdated; ?>"  width="170px" height="70px" >
                                            <br>
